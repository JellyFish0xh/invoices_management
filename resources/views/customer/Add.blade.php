...
@section('page-header')
				...
				<div class="breadcrumb-header justify-content-between">
					<div class="my-auto">
						<div class="d-flex">
							<h4 class="content-title mb-0 my-auto">اضافة عميل</h4>
						</div>
					</div>
				</div>
				<!-- breadcrumb -->
                    ...
                    <div class="col-lg-12 col-xl-12 col-md-12 col-sm-12">
                        <div class="card  box-shadow-0">
                            <div class="card-header">
                                <h4 class="card-title mb-1">اضافه عميل جديد</h4>
                            </div>
                            <div class="card-body pt-0">
                                <form class="form-horizontal" method="post" action="{{route("Customer.store")}}">
                                    @csrf
                                    <div class="form-group">
                                        <label class="form-text pt-1" for="inputName">اســم العميل</label>
