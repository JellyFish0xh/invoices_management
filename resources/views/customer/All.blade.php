...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">جميع العملاء</h4>
            </div>
        </div>
    </div>
    <!-- breadcrumb -->
                        ...
                        <table class="table text-md" id="example1">
                            ...
                            @foreach($all_supplier as $supplier)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('Customer.edit', $supplier->id) }}" class="btn btn-sm btn-warning"><i class="fas fa-edit"></i></a>
                                        <form action="{{ route('Customer.destroy', $supplier->id) }}" method="POST" style="display:inline;">
                                            @csrf
                                            @method('DELETE')
